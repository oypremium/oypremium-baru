...
const productsData = {
  youtube: {
    ...
    plans: [
      { name: 'FAMHEAD', note: 'Bisa invite 5 member', price: 'Rp 15.000', period: '/bulan', msg: 'YouTube Premium - FAMHEAD (Rp 15K/bulan)' },
      { name: 'FAMPLAN', note: 'Via invite', price: 'Rp 5.000', period: '/bulan', msg: 'YouTube Premium - FAMPLAN (Rp 5K/bulan)' },
      { name: 'INDIVIDUAL', note: 'Akun pribadi', price: 'Rp 15.000', period: '/bulan', msg: 'YouTube Premium - INDIVIDUAL (Rp 15K/bulan)' }
    ],
    features: [
  ...
  gemini: {
    ...
    plans: [
      { name: 'HEAD', note: 'Bisa invite 5 member', price: 'Rp 15.000', period: '/bulan', msg: 'Gemini AI PRO - HEAD (Rp 15K/bulan)' },
      { name: 'FAMPLAN', note: 'Join via invite', price: 'Rp 6.000', period: '/bulan', msg: 'Gemini AI PRO - FAMPLAN (Rp 6K/bulan)' }
    ],
    features: [
  ...
  chatgpt: {
    ...
    plans: [
      { name: 'HEAD', note: 'Bisa invite 4 member', price: 'Rp 30.000', period: '/bulan', msg: 'ChatGPT Business - HEAD (Rp 30K/bulan)' },
      { name: 'PRIVATE MEMBER', note: 'Private member', price: 'Rp 10.000', period: '/bulan', msg: 'ChatGPT Business - PRIVATE MEMBER (Rp 10K/bulan)' }
    ],
    features: [
      'GPT-4 Turbo unlimited',
      'Code Interpreter',
      'DALL-E 3 image generation',
      'Web browsing & search',
      'Full garansi 1 bulan',
      'Login assistance & support'
    ]
  },
  spotify: {
  ...
  modalBody.innerHTML = `
    <div class="product-detail">
      <div class="product-detail-header">
        <div class="product-detail-icon" style="background: ${product.gradient};">
          ${product.icon}
        </div>
        <div>
